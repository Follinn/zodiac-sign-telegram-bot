...
async def command_start(message : types.Message):
	await bot.send_message(message.from_user.id, '<b>Привет</b>, я бот проверки на совместимость по Знаку Зодиака. \nНапиши свой **Знак Зодиака и Знак Зодиака партнёра с которым хочешь проверить совеместимость**.\n \nОбязательно что бы знак женщины был слева, иначе совместимость может быть расчитана не правильно \n \nПРИМЕР водолей + овен. ПРОБЕЛ между + и знаками зодиака ОБЯЗАТЕЛЕН')
